                                        ...
                                        <div class="p-5" style = "margin-left: 112px">
                                            ...
                                            <form action="user.asp" id="user_form" method="POST">
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="name" name="name" value="<% =rs("Name")%>" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="address" name="address" disabled value="<% =rs("Address")%>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
