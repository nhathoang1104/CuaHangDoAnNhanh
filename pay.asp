                    ...
                    <%
                        ...
                        Else
                            ...
                            If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
                                ...
                                cmdPrep.CommandText = "INSERT INTO DonHang(MaKH, NguoiNhan, DiaChi, SoDT, TongTien) VALUES('" & makh & "',?,?, '" & Phone & "', '" & subtotal & "')"
                                cmdPrep.parameters.Append cmdPrep.createParameter("NguoiNhan",202,1,255,Name)
                                cmdPrep.parameters.Append cmdPrep.createParameter("DiaChi",202,1,255,Address)
                                cmdPrep.execute
