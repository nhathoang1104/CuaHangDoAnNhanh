                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        ...
                        %>
                                <tr>
                                    <td><%=rs("MaSP")%></td>
                                    <td><%= Server.HtmlEncode(rs("TenSP"))%></td>
                                    <td><%=rs("GiaBan")%></td>
                                    <td><%=Server.HtmlEncode(rs("GioiThieu"))%></td>
                                    <td><%=Server.HtmlEncode(rs("MoTaChiTiet"))%></td>
                                    <td><%=rs("AnhBia")%></td>
                                    <td><%=rs("NgayCapNhat")%></td>
                                    <td>
                                        <a href= "addeditsp.asp?MaSP=<%=rs("MaSP")%>" class="btn btn-secondary mb-2">Cập nhật sản phẩm</a>
                                        <a data-href="deletesp.asp?MaSP=<%=rs("MaSP")%>" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirm-delete" title="Delete">Xóa sản phẩm</a>
                                    </td>
                                </tr>
                        <%
                                rs.MoveNext
